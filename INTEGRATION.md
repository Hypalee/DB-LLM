...
> permettait d'importer DB-LLM dans un projet de prod (<projet>) via
> `@claude-config/...` dans le `CLAUDE.md` local. **Ce pattern n'est
> plus en usage** : <projet> a été découplé de DB-LLM le 2026-04-26 (PR
> Hypalee/<projet>#47), et DB-LLM n'a plus vocation à être importé
