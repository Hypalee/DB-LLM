...
- `projects/brain.md` (état spécifique du projet Brain).
...
```bash
git clone --recursive https://github.com/<owner>/Brain.git
# ou si déjà cloné :
...
```
DATABASE_URL=postgres://user:pass@neon.tech/brain
...
Besoin : ajouter une table `audit_logs` à la base Brain.
