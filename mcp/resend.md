...
notifications). Domaine envoyeur : `brain-app.app`.
...
1. **Toujours utiliser l'expéditeur `noreply@brain-app.app`** pour
   les emails transactionnels Brain. Pour un nouveau projet, utiliser
